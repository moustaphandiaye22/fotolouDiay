...
const upload = (0, multer_1.default)({
    storage: stockage,
    limits: {
        fileSize: parseInt(process.env.MAX_FILE_SIZE || '2097152'), // 2MB pour photos capturées
    ...
    fileFilter: (req, file, cb) => {
        ...
        // Vérification de la taille minimale (éviter les images trop petites)
        if (file.size && file.size < 5000) { // 5KB minimum
