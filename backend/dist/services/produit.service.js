...
class ServiceProduit {
     ...
     */
    static rechercherProduits() {
        return __awaiter(this, arguments, void 0, function* (filtres = {}) {
            try {
                const filtresRecherche = Object.assign(Object.assign({}, filtres), { statut: message_1.StatutProduit.VALIDE });
                const resultat = yield produit_repository_1.RepositoryProduit.trouverTous(filtresRecherche);
                return {
                    success: true,
